...
from database.classes import classes_atributos # type: ignore
from dotenv import load_dotenv
from handlers.midtheim.menu_midtheim import menu_midtheim # type: ignore
from handlers.midtheim.personagem import personagem
from handlers.midtheim.personagem import inventario
from handlers.midtheim.personagem import status
from handlers.midtheim.personagem.equipamentos import equipamentos
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ler_texto("textos/cadastro/nome.txt"),
        parse_mode="HTML"
    )
    session.close()
    return NOME
...
async def receber_nome(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    texto = ler_texto("textos/cadastro/classe.txt").format(nome=nome)
    await update.message.reply_text(
        texto,
